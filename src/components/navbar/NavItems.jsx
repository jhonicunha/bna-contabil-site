...
function NavList({ item, menuTextColor, isSticky }) {
...
export function NavMenu({ navItems, menuTextColor, isSticky }) {
  return navItems.map((item, index) => <NavList key={index} {...{ item, menuTextColor, isSticky }} />);
}
...
NavList.propTypes = { item: PropTypes.any, menuTextColor: PropTypes.string, isSticky: PropTypes.bool };

NavMenu.propTypes = { navItems: PropTypes.array, menuTextColor: PropTypes.string, isSticky: PropTypes.bool };
