    ...
    <ContainerWrapper>
      <Stack sx={{ width: 1, height: '100vh', py: SECTION_COMMON_PY, minHeight: { xs: 450, sm: 600, md: 800 } }}>
        <GraphicsCard sx={{ width: 1, height: 1, position: 'relative' }}>
          <Stack sx={{ alignItems: 'center', justifyContent: 'center', gap: 2, height: '75%', pt: 2 }}>
            <Box sx={{ mb: 1 }}>
              <LogoSection />
            </Box>
            <Box sx={{ width: 1, maxWidth: { xs: 340, sm: 486, md: 680 }, p: 1 }}>
              <Error500 />
            </Box>
            <Typography sx={{ textAlign: 'center', width: { xs: 260, sm: 360, md: 450 }, color: 'text.secondary' }}>{heading}</Typography>
